jQuery("#side-menu").click(function(e){
    ...
    if (jQuery("#sidebar-wrapper").hasClass("collapsed")){
        ...
        jQuery("#page-content-wrapper").removeClass("collapsed");
        jQuery("#page-content-wrapper").addClass("not-collapsed");
        ...
        jQuery("#page-content-wrapper").removeClass("not-collapsed");
        jQuery("#page-content-wrapper").addClass("collapsed");
...
jQuery("#sidebar-wrapper").height(jQuery("body")[0].scrollHeight);